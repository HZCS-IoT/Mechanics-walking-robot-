...
4. انتظر **MQTT: متصل ✓**
5. **يدوي:** اضغط ↑ أمام · ↓ خلف · 👋 تلويح (يسار/يمين)
6. **صوت:** اختر 🇸🇦 عربي أو 🇬🇧 English → 🎤 → تكلم

> **المشي:** كل ضغطة «أمام» = خطوة واحدة — اضغط **عدة مرات** (لا grip في الأقدام).
...
2. **لا تفتح** الملف محليًا (`file://`) — MQTT ما يشتغل بدون HTTPS
3. استخدم **نفس روابط InfinityFree** أعلاه
4. **يدوي:** `manual.html` — أزرار التحكم
5. **صوت:** `voice.html` — اسمح للميكروفون عند طلب المتصفح
...
> **طاقة:** المشي يحرّك **2 سيرفو** في كل مرحلة — مو الأربعة مع بعض. تشغيل 2 فقط للاختبار **آمن** وما يضر.
